...
const et = Q("string"), A = Q("function"), Fe = Q("number"), H = (e) => e !== null && typeof e == "object", tt = (e) => e === !0 || e === !1, J = (e) => {
  if (G(e) !== "object")
    return !1;
  const t = ue(e);
...
}, rt = C("Date"), st = C("File"), ot = C("Blob"), it = C("FileList"), at = (e) => H(e) && A(e.pipe), ct = (e) => {
  let t;
...
const Ut = (e) => {
  ...
  return n(e, 0);
}, Lt = C("AsyncFunction"), Bt = (e) => e && (H(e) || A(e)) && A(e.then) && A(e.catch), Be = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({ source: s, data: o }) => {
...
function Z(e, t, n) {
  ...
  function u(p, y, h) {
    ...
    if (p && !h && typeof p == "object") {
      ...
      else if (a.isArray(p) && qt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (E = a.toArray(p)))
        return y = je(y), E.forEach(function(g, P) {
...
const {
  ...
  try {
    return (await w.get(e, t)).data;
  } catch (n) {
    return console.error("GET API Error:", n), null;
  }
}, vn = async (e, t, n) => {
  try {
    return (await w.post(e, t, n)).data;
  } catch (r) {
    return console.error("POST API Error:", r), null;
  }
}, Xn = async (e, t, n) => {
  try {
    return (await w.put(e, t, n)).data;
  } catch (r) {
    return console.error("PUT API Error:", r), null;
  }
}, Gn = async (e, t) => {
  try {
    return (await w.delete(e, t)).data;
  } catch (n) {
    return console.error("DELETE API Error:", n), null;
  }
};
export {
  Gn as deleteApi,
